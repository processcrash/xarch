...
- Assuming good faith in disputes.
...
repository, Discussions, Issues, Pull Requests, project chat channels,
and any other forum used by the project — and also applies when an
...
at **`conduct@xarch.example`**. All complaints will be reviewed and
...
interaction with a community leader — for a specified period of time.
...
including unsolicited interaction with community leaders, is allowed
